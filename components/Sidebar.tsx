...
const Sidebar: React.FC<SidebarProps> = ({ user, onLogout, activePage, setActivePage }) => {
  const navItems = [
    {
      label: 'Core Subjects',
  ...
  return (
    <aside className="w-64 flex-shrink-0" aria-label="Sidebar">
      <div className="flex flex-col h-full overflow-y-auto bg-gray-800 p-4">
        <a href="#" onClick={() => setActivePage('Core Subjects')} className="flex items-center mb-5 text-white">
          ...
          <span className="self-center text-xl font-semibold whitespace-nowrap">CS Prep</span>
        </a>
